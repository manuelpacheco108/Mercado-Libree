...
const DrawerList = [
    { icon: 'home-outline', label: 'Home', navigateTo: 'Inicio' },
        ...
        <View style={styles.viewMain}>
            <DrawerContentScrollView {...props}>
                <View style={styles.drawerContent}>
                  ...
                  style={{marginTop: 5}}
                /> */}
                                <View style={styles.viewLastOne}>
                                    <Title style={styles.title}>Ingresa a tu cuenta</Title>
                                    <Text>Podrás ver detalles de envío y personalizar tu experiencia</Text>
